...
#       temporary variable and then reading that variable makes things work
#       with ksh and ash.  Cf. KSH88, Dash, BusyBox, Zsh, ksh93.
#
##############################################################################
...
# This is reliable for symlinks and the APP_HOME resolution
...
# temporary newlines resulting from word-splitting; this is a conservative
# version of the logic in Bash's `printf %q`.
eval "set -- $(
